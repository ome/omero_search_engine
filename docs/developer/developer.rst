...
Then create a Python virtual environment using either venv or conda. Install the packages using the :omero_search_engine: `requirements.txt <requirements.txt>` file.
