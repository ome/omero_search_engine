...
from omero_search_engine import (
    search_omero_app,
    create_app
)
...
class BasicTestCase(unittest.TestCase):
    ...
    def test_searchannotation(self):
        ...
        response = tester.post('/api/v1/resources/image/searchannotation/',
                               data=query)
        self.assertEqual(response.status_code, 200)
    ...
    def test_is_not_valid_json_query(self):
        ...
        test output of query builderis valid json
        '''
        no_valid_message = elasticsearch_query_builder(not_valid_and_filters,
                                                       not_valid_or_filters,
                                                       False)
