...
#The and query clauses should be like that:
...
recieved_results_data=[]
#we need to restrict the results to a specific owner,
#Here we can use the main attribute whihc can be used to add to the search terms like owner id, group id
