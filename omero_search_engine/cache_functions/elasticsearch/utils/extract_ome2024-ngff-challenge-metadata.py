...
def read_csv_files():
    ...
    resources_list = {}
    # contains sub files
    idr = "https://raw.githubusercontent.com/will-moore/ome2024-ngff-challenge/samples_viewer/samples/idr_samples.csv"  # noqa
    ...
    jax_1 = "https://raw.githubusercontent.com/TheJacksonLaboratory/jax-ngff-challenge-2024/refs/heads/main/KOMP_adult_lacZ.csv"  # noqa
    jax_1 == get_file_name(jax_1)
    jax_2 = "https://raw.githubusercontent.com/TheJacksonLaboratory/jax-ngff-challenge-2024/refs/heads/main/KOMP_histopathology.csv"  # noqa
    jax_2 = get_file_name(jax_2)
    resources_list["jax"] = {}
    resources_list["jax"]["metadata"] = {}
    resources_list["jax"]["files"] = [jax_1, jax_2]
    bia = "https://raw.githubusercontent.com/will-moore/ome2024-ngff-challenge/samples_viewer/samples/ebi-ngff-challenge-samples.csv"  # noqa
    bia = get_file_name(bia)
    resources_list["bia"] = {}
    resources_list["bia"]["metadata"] = {}
    resources_list["bia"]["files"] = [bia]
    Webknossos = "https://raw.githubusercontent.com/will-moore/ome2024-ngff-challenge/samples_viewer/samples/webknossos_samples.csv"  # noqa
    ...
    UniversityofMuenster = "https://raw.githubusercontent.com/JensWendt/ome2024-ngff-challenge/refs/heads/main/samples/uni_muenster_samples.csv"  # noqa
